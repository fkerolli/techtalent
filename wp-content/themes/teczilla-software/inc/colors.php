<?php 
function teczilla_software_inline_css(){
	
$teczilla_theme_color_scheme = get_theme_mod('teczilla_theme_color_scheme','#078586');
$teczilla_custom_css      = '';           
...
$teczilla_theme_secondary_color_scheme = get_theme_mod('teczilla_theme_secondary_color_scheme','#fff');               


$teczilla_custom_css      .= '.buttn li a
       {
        background: ' . esc_attr( $teczilla_theme_secondary_color_scheme) . ';
        border: 1px solid '. esc_attr( $teczilla_theme_secondary_color_scheme) . '}';


$teczilla_custom_css      .= '.sidebar
       {
       border-left: 1px solid '. esc_attr( $teczilla_theme_secondary_color_scheme) . '}';

$teczilla_custom_css      .= '.tec-footer .footer-bottom .copyright p
       {
       color: '. esc_attr( $teczilla_theme_secondary_color_scheme) . '}';
...
add_action( 'wp_enqueue_scripts', 'teczilla_software_inline_css',20 );
                              ...
                              <h2 class="banner-heading">
                                <?php if ( is_archive() ) {
                                 ...
                                 elseif(is_search()){
                                  ...
                                  echo  esc_html__('Search Results For ', 'teczilla-software') . ' " ' . get_search_query() . ' "';

                                 }elseif ( is_404() ) {
                                  echo  esc_html__('Nothing Found ', 'teczilla-software');
                                 }
                                 else{
