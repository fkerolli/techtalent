                ...
                <div class="container">
                    <div class="row y-middle">
                        <div class="col-lg-6">
                            ...
                            <p>
                            <?php
                            printf( __( 'Proudly powered by', 'teczilla-software' ) );
                            ?>

                            <a href="<?php echo esc_url( __( 'https://wordpress.org/', 'teczilla-software' ) ); ?>" class="imprint">
                            	
							<?php
                            printf( __( 'WordPress', 'teczilla-software' ) );
                            ?>
                            </a>
